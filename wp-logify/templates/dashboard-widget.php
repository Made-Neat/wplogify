...
echo '<a href="' . esc_url( admin_url( 'admin.php?page=wp-logify-settings' ) ) . '" title="WP Logify plugin settings"><span class="dashicons dashicons-admin-generic"></span></a>';
echo '</div>';

// Display the total activities
echo '<div class="wp-logify-stats">';
echo '<div class="wp-logify-stats-box">';
echo '<div class="wp-logify-stats-header">Events in the last hour: ' . esc_html( $activities_last_hour ) . '</div>';
echo '</div>';
echo '<div class="wp-logify-stats-box">';
echo '<div class="wp-logify-stats-header">Events in the last 24 hours: ' . esc_html( $activities_last_24_hours ) . '</div>';
echo '</div>';
echo '</div>';
...
echo '<a href="' . admin_url( 'admin.php?page=wp-logify' ) . '">View all site activity</a>';
echo '</div>';
?>
