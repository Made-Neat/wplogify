...
require_once WP_LOGIFY_PLUGIN_DIR . 'includes/database/models/class-property-array.php';
...
require_once WP_LOGIFY_PLUGIN_DIR . 'includes/objects/trackers/class-media-tracker.php';
