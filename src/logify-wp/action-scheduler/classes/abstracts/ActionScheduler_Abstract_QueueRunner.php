	...
	public function process_action( $action_id, $context = '' ) {
		...
		set_error_handler(
			...
			function ( $type, $message ) {
				// phpcs:ignore WordPress.Security.EscapeOutput.ExceptionNotEscaped -- Internal error message not displayed to users
	...
	protected function schedule_next_instance( ActionScheduler_Action $action, $action_id ) {
		...
		if (
			...
			ActionScheduler_Logger::instance()->log(
				$action_id,
				__('This action appears to be consistently failing. A new instance will not be scheduled.', 'logify-wp' )
			);
