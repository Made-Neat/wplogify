...
class ActionScheduler_DBLogger extends ActionScheduler_Logger {
	...
	public function bulk_log_cancel_actions( $action_ids ) {
		...
		ActionScheduler_TimezoneHelper::set_local_timezone( $date );
		$date_local = $date->format( 'Y-m-d H:i:s' );
		$message    = __('action canceled', 'logify-wp' );
		...
		$wpdb->query( $sql_query ); // phpcs:ignore WordPress.DB.PreparedSQL.NotPrepared,WordPress.DB.DirectDatabaseQuery.DirectQuery,WordPress.DB.DirectDatabaseQuery.NoCaching
	}
}
